    ...
    <>
      <section className="grid container">
          ...
          <div className="flex flex-row items-center justify-around w-1/4" >
            <button className="hint--top flex flex-row justify-center w-1/2 items-center h-12 dark:text-white-500 bg-cyan-200 hover:bg-cyan-400 dark:bg-cyan-900 dark:hover:bg-cyan-600 rounded" onClick={handleEditPrompt} aria-label="Edit prompt">
          ...
          <button className="btn-copy h-12 rounded flex flex-2 flex-grow  justify-center items-center ml-2 hint--top dark:text-white bg-cyan-200 hover:bg-cyan-400 dark:bg-cyan-900 dark:hover:bg-cyan-600" onClick={handleCopyDraft} aria-label="Copy to clipboard">
